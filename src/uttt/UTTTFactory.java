...
import uttt.game.implementation.BoardInterfaceImplement;
import uttt.game.implementation.MarkInterfaceImplement;
import uttt.game.implementation.SimulatorInterfaceImplement;
import uttt.ui.GUI;
...
public class UTTTFactory {
	...
	public static MarkInterface createMark(Symbol symbol, int j) {
		MarkInterface newMark = new MarkInterfaceImplement(j, symbol);
		return newMark;
	}
	...
	public static BoardInterface createBoard() {
		BoardInterface newBoard = new BoardInterfaceImplement();
		return newBoard;
	}
	...
	public static SimulatorInterface createSimulator() {
		SimulatorInterface newSimulator = new SimulatorInterfaceImplement();
		return newSimulator;
	}
